...
from my_utils import find_list_duplicates
...
def ena_description_annotate(all_ena_term_list):
    ...
    # ic(len(term_dict.keys()))
    #
    # in_ena_obj_all_terms_list = ena_cl_obj.get_all_term_list()
    # ic(in_ena_obj_all_terms_list[-5:])
    # ic(len(in_ena_obj_all_terms_list))
    # in_ena_obj_all_terms_set = set(in_ena_obj_all_terms_list)
    # ic(len(in_ena_obj_all_terms_set))
    # ic(find_list_duplicates(in_ena_obj_all_terms_list))
    #
    # ic(len(all_ena_term_list))
    # ic(all_ena_term_list[-5:])
    # all_ena_term_set = set(all_ena_term_list)
    # ic(len(all_ena_term_set))
    # ic(find_list_duplicates(all_ena_term_list))
    #
    # ic(all_ena_term_set.difference(in_ena_obj_all_terms_set))
    # tmp_list = in_ena_obj_all_terms_list
    #
    # ic(len(all_ena_term_set.union(in_ena_obj_all_terms_set)))
